...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...optionShit.length)
		{
			...
			menuItem.x = 30;
			menuItem.y -= 80;
			FlxTween.tween(menuItem,{x: 380 + (i * 160), 'scale.x': 0.7 - (i * 0.05), 'scale.y': 0.7 - (i * 0.05)},1 + (i * 0.25) ,{ease: FlxEase.expoInOut, onComplete: function(flxTween:FlxTween) 
					{ 
						changeItem();
					}});
		...
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "Friday Night Gaming ALPHA", 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.BACK)
			{
				...
				loadOut.alpha = 1;
				loadOut.animation.finishCallback = function(huh:String){MusicBeatState.switchState(new TitleState());}
			}
